...
(1, 'Esteban', 'correo@correo.cl', 'buen viaje');
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
(3, 'Pedro', 'pedro@pedro.com', 'Muy buena agencia');
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
(4, 'Juan', 'juan@juan.cl', 'Uno de los mejores viajes de mi vida');
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
(5, 'Roberto', 'roberto@correo.cl', 'Excelente servicio!!');
